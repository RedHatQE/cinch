...
# Tag the CentOS 7 image as the "latest" version, for people wanting the cutting edge
docker tag "redhatqecinch/jenkins_slave:cent7-${CINCH_VERSION}" redhatqecinch/jenkins_slave:latest
# Login to Docker - these environment variables are stored in TravisCI for safe keeping
